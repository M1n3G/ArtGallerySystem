        ...
        <div class="col-xl-12">
            <div class="card shadow-0 border rounded-3">
                <div class="card-header bg-white">
                    <h5 class="mt-2" style="font-family:'Poppins', sans-serif;">Report Violations Section
                        <a class="btn btn-primary text-capitalize float-end px-3" href="{{ route('reporthistory.list') }}">History</a>
                    </h5>
                </div>
