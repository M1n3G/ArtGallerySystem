                    ...
                    <div class="card-body px-4">
                        ...
                        <div class="artwork">
                            <div class="profileheader">
                                <p class="titlespan1 mt-3 fw-semibold">My Artwork
                                    <a id="add" class="btn btn-primary text-capitalize float-end px-3" data-bs-toggle="modal" data-bs-target="#modal-show" data-bs-whatever="@mdo">Add Artwork</a>
                                </p>
                                <hr />
                            </div>
                                    ...
                                    <tr class="candidates-list">
                                        <td class="title">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="thumb">
                                                        <img class="img-fluid" src="{{ asset($row->artImg)}}" width=150 height=200 style="max-width: 150px; max-height: 200px;" alt="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 candidate-list-details">
                                                    <div class="candidate-list-info">
                                                        <div class="candidate-list-title">
                                                            <h4 class="mb-0 fw-bold" style="font-size:27px; color: #0d6efd">{{$row->artName}}</h4>
                                                        </div>
                                                        <div class="details">
                                                            <!-- Category -->
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <div class="fw-semibold" style="color:#9d9d9d; font-size:13px;">
                                                                        {{$row->artYear}}
                                                                    </div>
                                                                </div>
                        ...
                        <td>
                            <ul class="list-unstyled mb-0 d-flex justify-content-end">
                                ...
                                <li><a href="{{route('artwork.edit',$row->artID) }}" class="btn btn-dark  px-2" style="padding: 6px 8px; height:35px; max-height:35px;">
                                        <i class="bi bi-pencil-square"></i></a>&nbsp&nbsp&nbsp
                                </li>
                                <form action="{{ route('artwork.delete',$row->artID) }}" method="POST" onsubmit="return confirm('Delete This Artwork?');">
                                    @csrf
                                    @method('DELETE')
                                    <li><button type="submit" class="btn btn-danger px-2" style="height:35px; max-height:35px;"><i class="far fa-trash-alt"></i></button>
                                        </a>
                                    </li>
                                </form>
                            </ul>
