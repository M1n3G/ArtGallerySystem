...
<div class="container py-5">
    <div class="row">
        <div>
            ...
            <button id="add" class="btn btn-light btn-lgs" style="float: right;margin-bottom:45px; " type="submit">Add
                Auction</button>
            @endif
        </div>
        @if(!empty($auction))
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <p class="wrap-countdown mercado-countdown medium text-muted"
                            data-expire="{{ Carbon\Carbon::parse($row->start_date)->format('Y/m/d h:i:s') }}"></p>
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <h5 class="text-dark mb-0">
                            ...
                            <div class="col mt-2">@if($row->bidPrice!=null)
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div><a class="btn-getstarted scrollto col mt-2"
                                href="{{ action('AuctionController@viewDetails', $row->auctionID ) }}"
                                style="text-decoration: none;">View Details</a></div>
                    </div>
                </div>
            </div>
        </div>
